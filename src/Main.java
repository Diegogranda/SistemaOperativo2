public class Main {
    public static void main(String[] args) {
        Computer1 c1 = new Computer1(" Pepe ", 320, 16);
        ...
        System.out.println("Los Softwares han sido desinstalados correctamente" + " Actualmente hay un espacio en el disco de: " + c1.getHardDisk() + " y una RAM de " + c1.getRamMemory());
        c1.format(os);
